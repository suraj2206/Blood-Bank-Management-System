        ...
        <form name="sentMessage"  method="post">
            <div class="control-group form-group">
                <div class="controls">
                    ...
                    <input pattern="[a-zA-Z -]+$" type="text" class="form-control" id="name" name="fullname" required>
            ...
            <div class="control-group form-group">
                <div class="controls">
                    ...
                    <input pattern="[0-9]+$"maxlength="10" type="tel" class="form-control" id="phone" name="contactno"  required >
                </div>
            </div>
            <div class="control-group form-group">
                <div class="controls">
