...
<body background="admin_image\sn-bloodcells.jpg">
  ...
  <form class="" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    <div class="container" style="margin-top:200px;">
      ...
      <div class="card" style="height: 300px; background-image:url('admin_image/glossy1.jpg');">
          <div class="card-body">
  ...
  <div class="row justify-content-lg-center justify-content-mb-center">
    ...
    <div class="col-lg-4 mb-4" style="text-align:center"><br>
        <div>
            <button name="back" id="backbutton" onclick="window.location.href='home.php'" class="btn1 btn-primary" style="cursor:pointer">BACK</button>
        </div>
    </div>
</div>
