...
<div id="content">
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div><input pattern="[a-zA-Z -]+$" type="text" name="fullname" class="form-control" required></div>
      </div>
      <div class="col-lg-4 mb-4"><br>
      <div class="font-italic">Mobile Number<span style="color:red">*</span></div>
      <div><input pattern="[0-9]+$" maxlength="10"type="text" name="mobileno" class="form-control" required></div>
      </div>
      <div class="col-lg-4 mb-4"><br>
      ...
      <div><input pattern="[0-9]+$" maxlength="2"type="text" name="age" class="form-control" required></div>
      </div>
